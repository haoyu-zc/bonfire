...
log_warn "IMPORTANT: Add your public key to ~/.ssh/authorized_keys before relying on key-only auth"
log_warn "PasswordAuthentication is disabled — ensure your key is added first"
